<%@ Page Title="linkedin |Profiles " Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="UserProfile.aspx.cs" Inherits="CustomerPortal.UserProfile" %>
            ...
            <div class="page-body">
                ...
                <div class="row">
                            ...
                            <ItemTemplate>
                                <div class="card">
                                    <div class="card-block user-radial-card">
                                        ...
                                        <div data-label="Img" class="radial-bar radial-bar-100 radial-bar-lg radial-bar-primary">
                                        ...
                                        <p><a href="<%# Eval("AccountLink") %> " target="_blank"><i class="fa fa-linkedin-square"> <%# Eval("UserName") %> </i></a></p>

                                        <p><i class="fa fa-map-marker"> <%# Eval("Location") %> </i></p>

                                        <div class="card table-card">
                                            <div class="card-header">
                                                <h3 class="sub-title text-c-lite-green">About</b></h3>
                    ...
                    <div class="col-md-6 col-lg-9">
                        <iframe width="100%" height="650" runat="server"  id="pdfFream" >
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="User" ItemStyle-Width="15%" DataField="UserName"   NullDisplayText="--" />
                                                         ...
                                                         <asp:TemplateField HeaderText="Account"   ItemStyle-Width="5%" >
                                                            ...
                                                            <ItemTemplate>
                                                                <p><a href="<%# Eval("AccountLink") %> " target="_blank"><i class="fa fa-linkedin-square"> view   </i></a></p>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                     </Columns>
